describe("Restangular", function() {
  ...
  beforeEach(inject(function($injector) {
    ...
    $httpBackend.whenGET("/accounts?page=4").respond(accountsModel);
  ...
  describe("Scoped Service", function() {
    ...
    it("should allow extend services", function() {
      var childRestangular = Restangular.withConfig(function(config) {
      ...
      var Accounts = childRestangular.service("accounts");
      Accounts.paginate(4);

      $httpBackend.expectGET('/accounts?page=4');
      $httpBackend.flush();
    });
